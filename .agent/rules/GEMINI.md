...
> **Purpose:** Implement mobile web components for Hoai Minh ERP.
...
5. **Restart Server / App Pool** — Server caches API list for 30 min (Restart IIS App Pool via your server panel or Web Deploy process)
