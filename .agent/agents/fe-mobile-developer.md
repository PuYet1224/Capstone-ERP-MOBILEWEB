...
3. **If NOT connected:**
   - Notify: *"Figma not connected. Open Figma Desktop + plugprint?"*
...
- Path: `{PIPELINE_ROOT}\guides\FEMobile_*_{FeatureName}.md`
...
## FORBIDDEN
- Hardcode hex colors in SCSS -- use `$primary`, `$error`, `$warning`, `$printfo`
