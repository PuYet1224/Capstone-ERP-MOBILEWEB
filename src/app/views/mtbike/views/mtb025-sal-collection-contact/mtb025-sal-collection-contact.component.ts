...
export class Mtb025SalCollectionContactComponent {
  ...
  // private getlistcslist(forceReload: boolean = false) {
  //   this.subLoader.loader(true);
  //   var temp = this.configCache.GetListCSList(CSListTypeDataEnum.FREETIME, forceReload).subscribe((res) => {
  //     if (res) {
  //       this.listtype = res;
  //       this.subLoader.loader(false);
  //     } else {
  //       this.subLoader.loader(false);
  //       this.notification.onError(`Lỗi lấy danh sách thể loại thời gian`);
  //     }
  //   }, (err) => {
  //     this.subLoader.loader(false);
  ...
  // private getlisthrlist(forceReload: boolean = false) {
  //   this.subLoader.loader(true);
  //   var temp = this.configCache.GetListHRList(HRListTypeDataEnum.OCCUPATION, forceReload).subscribe((res) => {
  //     if (res) {
  //       this.listjob = res;
  //       this.subLoader.loader(false);
  //     } else {
  //       this.subLoader.loader(false);
  //       this.notification.onError(`Lỗi lấy danh sách thông tin nghề nghiệp`);
  //     }
  //   }, (err) => {
  //     this.subLoader.loader(false);
