...
import { PURDOMasterStatusEnum } from '../../models/enums/e-status/pur-do-master-status.enum';

@Pipe({
  name: 'PURDOMasterStatus'
})

export class PURDOMasterStatusPipe implements PipeTransform {
  constructor(private sanitizer: DomSanitizer) { }

  transform(status: { Status: PURDOMasterStatusEnum, StatusName: string }): SafeHtml {
    let html = ``;
    ...
    switch (status.Status) {
      case PURDOMasterStatusEnum.NEW:
        ...
        break;
      case PURDOMasterStatusEnum.WAITINGDELIVERY:
        ...
        break;
      case PURDOMasterStatusEnum.DELIVERING:
